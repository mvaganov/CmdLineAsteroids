...
Even if machines generate code, they still need humans to ground algorithms in reality, to identify and solve real problems.
...
Learning how to build simulations yourself, in a basic tech stack like the command line, is a powerful skill for teaching AI.
Practice with programming paradigms and syntax will help validate code from machine tools and communicate with them further.
These skills will make you useful to AI in the future. With these skills, you can help shape how machine intelligence connects to human reality.

This tutorial is my attempt to convey understanding about simulation development, far beyond syntax. If you follow this tutorial and understand it, you will be better equipped to create and debug simulations.
...
I want to include exactly this kind of content in my educational tutorial because I believe this is extremely valuable for less experienced developers to be exposed to.
	Programmers do not all agree about style, and even disagree about substance.
	As a programmer, you should practice agreeing with things. your mind needs to be flexible, to adopt the thinking of the main contributor on your project. that's just more productive.
