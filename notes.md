...
One invisible wizard problem that I can mention now is the tradeoff of robustness vs accessibility of this simulation.
	...
	I'll introduce many concepts in a way that is easy to practice while still being robust enough to iterate quickly.
		I apologize that some of this tutorial will jump around to different files to make modifications and explain concepts.
		Prepare yourself for this jarring experience. Be ready to pause the video to copy any code.
...
This tutorial is my attempt to convey understanding about simulation development, beyond syntax. If you follow this tutorial and understand it, you will be better equipped to create simulations, and debug simulation code generated by machine tools.
